 ...
 *
 * Server-only. Imported from TanStack Start server functions to start
 * per-user OAuth and to call provider APIs on behalf of the app user that
 * completed consent. Never import this from browser code.
 */
